...
bottomGround = createSprite(200,1000,1000,20);
...
obstacleTop.y = Math.round(random(100,300));
...
{
  if(World.frameCount % 60 === 0) {
    obstacleBottom = createSprite(width+10,500,40,50);
    obstacleBottom.y = Math.round(random(300,500));
obstacleBottom.addImage(obsBottom1);
obstacleBottom.debug=true


obstacleBottom.scale = 0.1;
obstacleBottom.velocityX = -9;
